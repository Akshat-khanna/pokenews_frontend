...
import PokenewsBg from '../../images/pokenews_bg.jpg'
        ...
        <Container>
            <Grid container className={classes.gridContainer} justifyContent="space-between" align="stretch" spacing={3}>
                <div className={classes.formBg}>
                    <img src={PokenewsBg} alt="PokenewsBg" />
                </div>
                <Grid item className={classes.formContainer}>
                    <Form currentId={currentId} setCurrentId={setCurrentId} />
                    <Typography variant="h6" style={{ color: 'white', textAlign: 'center', marginTop: '20px', marginBottom: '10px' }}>Search a pokemon by name / tags</Typography>
